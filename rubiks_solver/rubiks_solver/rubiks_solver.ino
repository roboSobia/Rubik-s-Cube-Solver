...
// Shared step and direction pins for ESP32
#define DIR_PIN 16   // GPIO16 (safe for output)
#define STEP_PIN 17  // GPIO17 (safe for output)

// Enable pins for each motor (active LOW)
#define ENABLE_PIN_frontStepper 26  // GPIO26
#define ENABLE_PIN_leftStepper 27   // GPIO27
#define ENABLE_PIN_rightStepper 14  // GPIO14
#define ENABLE_PIN_backStepper 12   // GPIO12 (safe if not used for boot)
#define ENABLE_PIN_downStepper 13   // GPIO13
...
void setup() {
  ...
  Serial.println("Rubik's Cube Motor Control Initialized on ESP32");
